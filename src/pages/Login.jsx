            ...
            <div className="w-full p-6 rounded-lg shadow-md bg-gray-200">
                ...
                <form onSubmit={handleSubmit}>
                    <div>
                        ...
                        <input value={email} onChange={(e) => setEmail(e.target.value)} type="email" placeholder="Enter Your Email" className="w-full input input-bordered h-10" />
                    </div>
                    ...
                    <div>
                        <button className="btn btn-block btn-sm mt-2 bg-blue-700 font-bol1d text-white" disabled={loading}>{loading? (<span className="loading loading-spinner"></span>) : "Login"}</button>
                    </div>
                </form>
            </div>
        </div>
